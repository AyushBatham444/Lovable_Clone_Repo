...
public class BillingController {
    ...
    private final PlanService planServiceObj;
    ...
    public ResponseEntity<List<PlanResponse>> getAllPlans(){
        return ResponseEntity.ok(planServiceObj.getAllActivePlans());
    }
