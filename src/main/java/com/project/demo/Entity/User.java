...
@Builder
@Table(name = "users")
public class User implements UserDetails {  // you cant use the table name as user as user is a predefined word in db/application so use @table annotation to rename it
